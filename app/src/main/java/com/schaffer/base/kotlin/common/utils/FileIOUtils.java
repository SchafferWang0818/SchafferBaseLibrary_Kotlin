...
/**
 * <pre>
 * {@link #writeFileFromIS}: 将输入流写入文件
 * {@link #writeFileFromBytesByStream }: 将字节数组写入文件
 * {@link #writeFileFromBytesByChannel}: 将字节数组写入文件
 * {@link #writeFileFromBytesByMap    }: 将字节数组写入文件
 * {@link #writeFileFromString        }: 将字符串写入文件
 * {@link #readFile2List              }: 读取文件到字符串链表中
 * {@link #readFile2String            }: 读取文件到字符串中
 * {@link #readFile2BytesByStream     }: 读取文件到字节数组中
 * {@link #readFile2BytesByChannel    }: 读取文件到字节数组中
 * {@link #readFile2BytesByMap        }: 读取文件到字节数组中
 * {@link #setBufferSize              }: 设置缓冲区尺寸
 * </pre>
 */
